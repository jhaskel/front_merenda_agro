...
class BlocEstoque1 extends BlocBase {
...
//Stream that receives a number and changes the count;
  ...
  var _counterController = BehaviorSubject<List<Estoque>>.seeded([]);
...
//output
  Stream<List<Estoque>> get outPage => _counterController.stream;
...
//input
  Sink<List<Estoque>> get inPage => _counterController.sink;
