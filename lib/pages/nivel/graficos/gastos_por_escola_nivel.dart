...
class GastosPorEscolaNivel extends StatefulWidget {
  int id;
  GastosPorEscolaNivel(this.id);


  @override
  _GastosPorEscolaNivelState createState() => _GastosPorEscolaNivelState();
}

class _GastosPorEscolaNivelState extends State<GastosPorEscolaNivel> {
  ...
  @override
  void initState() {
    _blocItens.fetchTotalEscolaNivel(context,widget.id,ano);
