...
class MediaPorAlunosEscola extends StatefulWidget {
  int id;

  MediaPorAlunosEscola(this.id);

  @override
  _MediaPorAlunosEscolaState createState() => _MediaPorAlunosEscolaState();
}

class _MediaPorAlunosEscolaState extends State<MediaPorAlunosEscola> {
  ...
  @override
  void initState() {
    _blocItens.fetchMediaAlunosEscola(context,widget.id,ano);
