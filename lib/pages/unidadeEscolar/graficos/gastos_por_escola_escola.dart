...
class GastosPorEscolaEscola extends StatefulWidget {
  int id;
  GastosPorEscolaEscola(this.id);


  @override
  _GastosPorEscolaEscolaState createState() => _GastosPorEscolaEscolaState();
}

class _GastosPorEscolaEscolaState extends State<GastosPorEscolaEscola> {
  ...
  @override
  void initState() {
    _blocItens.fetchTotalEscolaEscola(context,widget.id,ano);
