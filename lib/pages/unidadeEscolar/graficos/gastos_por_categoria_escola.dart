...
class GastosPorCategoriaEscola extends StatefulWidget {
 int id;
  GastosPorCategoriaEscola(this.id);

  @override
  _GastosPorCategoriaEscolaState createState() => _GastosPorCategoriaEscolaState();
}

class _GastosPorCategoriaEscolaState extends State<GastosPorCategoriaEscola> {
  ...
  @override
  void initState() {
    _blocItens.fetchTotalCategoriaEscola(context,widget.id,ano);
