...
class AfPdf extends StatefulWidget {
  ...
  AfPdf(this.key,this.list,this.af,this.nome,this.nomeNivel) : super(key: key);
  @override
...
//Add the rows to the grid
    ...
    header.cells[0].value= 'AF nº ${widget.af.code}';
    header.cells[5].value= dataPedido;

    PdfGridRow headerFor = grid.headers[1];
    headerFor.cells[0].value= ' ${widget.nome}';
...
//Add rows to grid
    ...
    row2.cells[0].value = 'Total da AF';
    row2.cells[1].value = '';
    row2.cells[2].value = '';
    row2.cells[3].value = '';
    row2.cells[4].value = '';
    ...
    row5.cells[0].value = 'Braço do Trombudo, ${hoje}';
    row5.height = 30;
    ...
    row7.cells[0].value = 'Cátia Regina Marangoni Geremias';
    row7.height = 20;

    PdfGridRow row8 = grid.rows.add();
    row8.cells[0].value = 'Secretária da Educação';
    row8.height = 20;
...
//Draw the grid
    ...
    headerElement.graphics.drawString(
        'AF-${widget.af.code}', PdfStandardFont(PdfFontFamily.helvetica, 10),
