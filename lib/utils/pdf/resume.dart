...
Future<Uint8List> generateResume(PdfPageFormat format) async {
  ...
  final profileImage = pw.MemoryImage(
    (await rootBundle.load('assets/imgs/user_logo.png')).buffer.asUint8List(),
  );
...
Future<pw.PageTheme> _myPageTheme(PdfPageFormat format) async {
  ...
  return pw.PageTheme(
    ...
    theme: pw.ThemeData.withFont(
      ...
      bold: pw.Font.ttf(await rootBundle.load('assets/fonts/roboto/Roboto-Regular.ttf')),
      icons: pw.Font.ttf(await rootBundle.load('assets/fonts/roboto/Roboto-Regular.ttf')),
    ),
