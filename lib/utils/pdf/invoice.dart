...
class Invoice {
  ...
  Future<Uint8List> buildPdf(PdfPageFormat pageFormat) async {
    ...
    final font1 = await rootBundle.load('assets/fonts/roboto/Roboto-Regular.ttf');
    final font2 = await rootBundle.load('assets/fonts/roboto/Roboto-Regular.ttf');
    final font3 = await rootBundle.load('assets/fonts/roboto/Roboto-Regular.ttf');

    _logo = await rootBundle.loadString('assets/resume.svg');
