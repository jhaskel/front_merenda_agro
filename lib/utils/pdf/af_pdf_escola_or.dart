...
class AfPdfEscolaOr extends StatefulWidget {
  /// Creates pdf with header and footer
  Key key;
  List<PedidoItens> list;
  String nomeFor;

  AfPdfEscolaOr(this.key,this.list, this.nomeFor ) : super(key: key);
  @override
  _AfPdfEscolaOrState createState() => _AfPdfEscolaOrState();
}

class _AfPdfEscolaOrState extends State<AfPdfEscolaOr> {
  _AfPdfEscolaOrState();
